...
{
	mvprintw(NC_DEBUG_Y + datas->i_debug++, NC_DEBUG_X, "test 1"); 		return (0);
}	code >>= 2;
	if (((b & 1) != (code & 3)) && ((b & 2) != (code & 3)) && ((b & 4) && (code & 3) != 3))
{
	mvprintw(NC_DEBUG_Y + datas->i_debug++, NC_DEBUG_X, "test 2"); 		return (0);
}	code >>= 2;
	if (((a & 1) != (code & 3)) && ((a & 2) != (code & 3)) && ((a & 4) && (code & 3) != 3))
{
		mvprintw(NC_DEBUG_Y + datas->i_debug++, NC_DEBUG_X, "test 3");		return (0);
}
